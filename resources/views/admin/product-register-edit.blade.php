...
<div class="blue-board_admin">
    ...
    <div class="man-body_b ">
        {{-- 編集 --}}
        @if (isset($product) || null !== old('id'))
        <form method="post" action="{{route('admin.product-edit-confirm')}}" enctype="multipart/form-data">
            @csrf
            <div class="element_wrap_str">
                <label for="id">ID</label>
                <div class="content-wrap">
                    @if (null == old('id'))
                    {{$product->id}} @else {{old('id')}} @endif
                    <input name="id" value="@if (null == old('id')){{$product->id}}@else {{old('id')}} @endif" hidden>
                </div>
            </div>
            <div class="element_wrap_str">
        ...
        {{-- 登録 --}}
        @else
        <form method="post" action="{{route('admin.product-register-confirm')}}" enctype="multipart/form-data">
            @csrf
            <div class="element_wrap_str">
                <label for="id">ID</label>
                <div class="content-wrap">
...
<script>
    $(function() {
        ...
        $('#product_subcategory_id_edit').remove();
